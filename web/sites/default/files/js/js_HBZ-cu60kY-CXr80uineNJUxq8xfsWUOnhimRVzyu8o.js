...
(function ($, Drupal) {
  ...
  Drupal.behaviors.sub_cats = {
    attach: function (context, settings) {
      // $('[id^=edit-cats-name]').on('keyup', function() {
      //   alert("a");

      // });
      // setCaretPosition('[id^=edit-cats-name]', 10);
...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.jek_12_FormJek12 = {
    attach: function (context, settings) {
      // let typingTimer;
      // console.log("a");
      // $('[id^="edit-cats-name"]').on('keyup', function (e) {
      //   console.log("b");
      //   clearTimeout(typingTimer);
      //   if ($(this).val()) {
      //     let trigid = $(this);
      //     typingTimer = setTimeout(function () {
      //       trigid.triggerHandler('finished_input');
      //     }, 1100);
      //   }
      // });
//       function bala (elem) {
...
//       }
// bala($('[id^="edit-cats-name"]'));
//       console.log(typeof($('[id^="edit-cats-name"]')));
//       let input = $('[id^="edit-cats-name"]');
//       input.on('keyup', ()=> {
//         console.log($('[id^="edit-cats-name"]')[0]);
//         input.focus();
//         input.selectionStart = input.val.length;
//       });
      $('[id^="edit-cats-name"]').keypress(function() {
        console.log('asfd');
        setTimeout( function() {
          $('[id^="edit-cats-name"]').selectionStart = 0;
          $('[id^="edit-cats-name"]').selectionEnd = 400;
        }, 1);
      });
